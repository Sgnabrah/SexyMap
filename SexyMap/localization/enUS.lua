...
L["Match player rotation"] = true
L["Normal rotation"] = true
L["Reverse rotation"] = true
L["Do not match player rotation"] = true
L["Texture tint"] = true
...
-- ./HudMap.lua
L["Enable a HUD minimap. This is very useful for gathering resources, but for technical reasons, the HUD map and the normal minimap can't be shown at the same time. Showing the HUD map will turn off the normal minimap. You can bind a key to toggle the HudMap on and off in the Keybinding menu."] = true
L["Keybinding"] = true
